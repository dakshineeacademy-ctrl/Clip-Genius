...
const Editor: React.FC<EditorProps> = ({ videoUrl, clips, onReset }) => {
  ...
  const handleExport = async () => {
    ...
    // We connect the video audio to a destination node for recording
    // And also to the context destination so the user can hear it (feedback)
